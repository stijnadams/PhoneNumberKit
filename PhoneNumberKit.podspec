...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  s.description      = <<-DESC
                        A Swift framework for parsing, formatting and validating international phone numbers. Inspired by Google's libphonenumber. Forked version. All credit belongs to the original author.
                       DESC
  ...
  s.source           = { :git => "https://github.com/stijnadams/PhoneNumberKit.git", :tag => s.version.to_s }
